...
const ROW3_LETTERS = ['Z', 'X', 'C', 'V', 'B', 'N', 'M'];

const R1_KEY_W = Math.floor((SW - KB_PADDING * 2 - KEY_GAP * 9) / 10);
const R2_KEY_W = Math.floor((SW - KB_PADDING * 2 - KEY_GAP * 8) / 9);
const SPECIAL_W = Math.floor(R1_KEY_W * 1.55);
const R3_KEY_W = Math.floor((SW - KB_PADDING * 2 - KEY_GAP * 8 - SPECIAL_W * 2) / 7);
...
export function EnglishKeyboard({ onLetterPress, onDelete, onEnter, letterStates, disabled, canSubmit }: Props) {
